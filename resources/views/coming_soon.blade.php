...
<div id="page-container" class="main-content-boxed">
    ...
    <main id="main-container">
        ...
        <!-- Page Content -->
        <div class="bg-image" style="background-image: url('{{asset('assets/media/photos/photo23@2x.jpg')}}');">
            <div class="hero bg-black-op">
                <div class="hero-inner">
                    <div class="content content-full">
                        <div class="row justify-content-center">
                            <div class="col-md-6 py-30 text-center">
                                <h1 class="display-4 font-w700 text-white mb-10">SportPlan</h1>
                                ...
                                <a class="btn btn-hero btn-noborder btn-rounded btn-outline-warning" href="{{'/'.Auth::user()->role.'/programs'}}">
                                    <i class="fa fa-arrow-left mr-10"></i> Go Back to SportPlan
                                </a>
                            </div>
                        </div>
                    </div>
