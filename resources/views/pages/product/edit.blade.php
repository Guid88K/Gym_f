    ...
    <div class="content">
        <div class="my-50 text-center">
            <h2 class="font-w700 text-black mb-10">
                <i class="fa fa-plus text-muted mr-5"></i> Редактировать новый продукт
            </h2>
...
{{--                                Pay extra attention since this is the data which customers will see first.--}}
                        ...
                        <div class="col-lg-7 offset-lg-1">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{$product->name}}" class="form-control form-control-lg" id="re-listing-name" name="name" placeholder="">
                            </div>
                            <div class="form-group">
                                <label for="re-listing-deliver">Доставка</label>
                                <select class="form-control form-control-lg" id="re-listing-deliver"
                                        name="delivery">
                                    <option {{ $product->delivery == 'Платная доставка' ? 'selected' : '' }} value="Платная доставка">Платная доставка</option>
                                    <option {{ $product->delivery == 'Бесплатная доставка' ? 'selected' : '' }} value="Бесплатная доставка">Бесплатная доставка</option>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="{{$product->url}}" class="form-control form-control-lg" id="re-listing-address" name="url" placeholder="">
                            </div>

                            <div class="form-group row">
                                <div class="col-md-8">
                                    <label for="re-listing-price">Цена</label>
                                    <input type="text" value="{{$product->price}}" class="form-control form-control-lg" id="re-listing-price" name="price" placeholder="">
                                </div>
                            </div>
                        </div>
                    </div>
