...
export default class Helpers {
     ...
     * Example usage:
     *
     * Please check out the Tabs pages for complete markup examples
     *
     */
     ...
     *
     * Example usage (on click, the pages will scroll to element with id "elementID" in "500" ms):
     *
    ...
    static coreScrollTo() {
        jQuery('[data-toggle="scroll-to"]:not(.js-scroll-to-enabled)').on('click.cb.helpers.core', e => {
            ...
            // Set variables
            let lHeader         = jQuery('#pages-header');
            let el              = jQuery(e.currentTarget);
            let elTarget        = el.data('target') || el.attr('href');
            let elSpeed         = el.data('speed') || 1000;
            let headerHeight    = (lHeader.length && jQuery('#pages-container').hasClass('page-header-fixed')) ? lHeader.outerHeight() : 0;
     ...
     *
     * Third party plugin inits or various custom user interface helpers to extend functionality
     * They need to be called in a pages to be initialized. They are included to be easy to
     ...
     */
      ...
      *
      * Helpers.run('print-pages');
      *
      */
    static print() {
        // Store all #pages-container classes
        let lPage = jQuery('#pages-container');
        let pageCls = lPage.prop('class');

        // Remove all classes from #pages-container
        lPage.prop('class', '');

        // Print the pages
        window.print();

        // Restore all #pages-container classes
     ...
     * Example usage:
     *
     * Please check out the Table Helpers pages for complete markup examples
     *
     */
     ...
     * Example usage:
     *
     * Please check out the Filtering pages in Components for complete markup examples
     *
     */
     ...
     * Example usage:
     *
     * Please check out the Gallery pages in Components for complete markup examples
     *
     */
    static magnific() {
     ...
     * Example usage:
     *
     * Please check out the Form plugins pages for complete markup examples
     *
     */
    static maskedInputs() {
        // Init Masked Inputs
     ...
     * Example usage:
     *
     * Please check out the Syntax Highlighting pages in Components for complete markup examples
     *
     */
    static highlightjs() {
        // Init Highlight.js
     ...
     * Example usage:
     *
     * Please check out the Notifications pages for examples
     *
     */
     ...
     * Example usage:
     *
     * Please check out the Draggable pages in Blocks for examples
     *
     */
